function trackPets() {
  const SHEET_NAME = "x";
  const WEBHOOK_URL = "https://discord.com/api/webhooks/x";
  const BASE_IMAGE_URL = "https://ps99.biggamesapi.io/image/";
  const API_URL = "https://ps99.biggamesapi.io/api/exists";
